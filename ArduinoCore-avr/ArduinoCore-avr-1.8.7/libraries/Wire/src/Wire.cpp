...
TwoWire::TwoWire(I2C_HandleTypeDef *&hi2c_ref) : hi2c(hi2c_ref) {}

// Public Methods //////////////////////////////////////////////////////////////

void TwoWire::I2C_Reset(void) {
    __HAL_I2C_DISABLE(hi2c);
#if defined(I2C_CR1_SWRST)
...
uint8_t TwoWire::requestFrom(uint8_t address, uint8_t quantity, uint32_t iaddress, uint8_t isize, uint8_t sendStop) {
    ...
    I2C_Reset();
    HAL_I2C_Master_Receive(hi2c, address << 1, rxBuffer, quantity, HAL_MAX_DELAY);
...
uint8_t TwoWire::endTransmission(uint8_t sendStop) {
    ...
    uint8_t ret = 0;
    I2C_Reset();
    HAL_I2C_Master_Transmit(hi2c, txAddress << 1, txBuffer, txBufferLength, HAL_MAX_DELAY);
    // reset tx buffer iterator vars
    txBufferIndex = 0;
    txBufferLength = 0;
